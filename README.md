...
Такая схема снизит вероятность выполнения запросов между шардами, что повысит производительность, а также упростит управление транзакциями и обеспечение их целостности   
