...
В проекте будет использоваться 3 разных вида хранилища данных. Информация о сессиях пользователей будет располагаться в key-value 
нереляционной СУБД, "файловые" данные (фотографии, видео) - в CDN, вся остальная основная информация будет находиться в реляционной СУБД, для 
которой необходимо спроектировать схему.

### Логическая схема реляционной БД
...
- Запись одной сессии в key-value хранилище ~ 150 байт.  
